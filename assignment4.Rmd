...
lobster_size <- ggplot(size_freq_summary, aes(x = SITE, y = mean)) +
  ...
  geom_signif(stat="identity", data = data.frame(x=c(0.875, 1.875), xend=c(10, 10),
                              y=c(90, 100), annotation=c("**", "NS")),
  ...
  geom_signif(stat="identity", comparisons = list(c("CARP", "NAPL")), map_signif_level=TRUE, annotations = c("*")) +
  geom_signif(stat="identity", comparisons = list(c("IVEE", "NAPL")), map_signif_level = TRUE, annotations = c("**"))+
