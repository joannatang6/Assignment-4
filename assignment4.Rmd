...
In IVEE and NAPL, the two MPA sites, mean lobster size increased from 2012 to 2017. Isla Vista showed a significant difference in lobster mean sizes between 2012 and 2017 (t (28.09) = -2.20, _p_ = 0.04, $\alpha$ = 0.05), with mean lobster size increasing from 66.08±12.09 mm to 71.45±14.32 mm. NAPL also increased over time from 73.00±11.75 mm to 76.23±11.39 mm, although these results were not statistically significant (t (5.52) = -0.66, _p_ = 0.54, $\alpha$ = 0.05).  Overall, MPA designation appears to positively impact lobster size.

Unlike the MPA sites, there is no consistency between AQUE, MOHK, and CARP, the non-MPA sites, on lobster size differences between 2012 and 2017. AQUE mean lobster size increased from 71.00±10.15 mm to 73.90±11.90 mm, although these resuls were not statistically significant (t (87.35) = -1.32, _p_ = 0.19, $\alpha$ = 0.05). CARP, on the other hand, showed a decrease in mean lobster size from 74.36±14.62 mm to 72.23±13.21 mm, although this also was not statistically significant (t (91.46) = 1.23, _p_ = 0.22, $\alpha$ = 0.05). MOHK, on the other hand, showed a significant difference in size between years (t (142.79) = 3.89, _p_ < 0.01, $\alpha$ = 0.05), with lobster size decreasing from 77.25±10.59 mm to 72.00±9.28 mm. These data also highlight the trend between abundance and mean lobster size. AQUE abundance did not change drastically over time, so neither did its mean lobster size. However, abundance did increase at MOHK and CARP, followed by a decrease in mean lobster size.
...
```
**_Proportion of legal lobsters at each site in 2017_**

We found proportions of “legal” sized lobsters (>82.6 mm carapace length) in catch across sites in 2017 to be significantly different ($\chi$^2^(4) = 18.50, _p_ < 0.001, $\alpha$ = 0.05). Coinciding with our lobster size results across all sites for 2017, we found that NAPL has the greatest proportion of “legal” sized lobsters. 
