...
# 2a. Boxplots of lobster sizes (1 graph of 5 side-by-sides, 1 per site)
# 2b. ANOVA of lobster sizes (2017)
# 3a. Boxplots of lobster sizes (5 graphs of side-by-side 2012-2017, 1 for each site)
...
```{r echo = FALSE, message = FALSE}
# 2a. Compare mean lobster size by site in 2017: Boxplots
...
# 3a. Changes in lobster size at MPA and non-MPA sites (comparing 2012 vs. 2017): Boxplots
...
size_chi <- chisq.test(legal_size_prop)
size_chi
# p = .9985, no significant association
